 ...
 */function y(t){return Ei({...t,state:!0,attribute:!1})}const Cr="/api";class _o{getAuthHeader(){const e=localStorage.getItem("authHeader");return e?{Authorization:e}:{}}async request(e,r={}){const n=`${Cr}${e}`,i=this.getAuthHeader(),o=await fetch(n,{headers:{"Content-Type":"application/json",...i,...r.headers},...r});if(!o.ok)throw new Error(`API request failed: ${o.status} ${o.statusText}`);return o.json()}async getAllUsers(){return this.request("/users")}async getUserById(e){return this.request(`/users/${e}`)}async getUserProfile(){return this.request("/users/me")}async createUser(e){const r={firstName:e.name.split(" ")[0]||"",lastName:e.name.split(" ").slice(1).join(" ")||"",email:e.email,password:e.password||"defaultPassword123",phone:e.phone};return this.request("/users/register",{method:"POST",body:JSON.stringify(r)})}async updateUser(e,r){const n={firstName:r.name.split(" ")[0]||"",lastName:r.name.split(" ").slice(1).join(" ")||"",email:r.email,phone:r.phone};return this.request(`/users/${e}`,{method:"PUT",body:JSON.stringify(n)})}async deleteUser(e){await this.request(`/users/${e}`,{method:"DELETE"})}async login(e){const r=btoa(`${e.username}:${e.password}`);try{const n=await fetch(`${Cr}/users/me`,{headers:{Authorization:`Basic ${r}`}});if(!n.ok)throw new Error("Invalid credentials");const i=await n.json();return localStorage.setItem("authHeader",`Basic ${r}`),localStorage.setItem("isAuthenticated","true"),localStorage.setItem("username",e.username),{user:i}}catch(n){throw localStorage.removeItem("authHeader"),localStorage.removeItem("isAuthenticated"),localStorage.removeItem("username"),n}}async getCurrentUser(){return this.request("/users/me")}async getAllResearches(){return this.request("/Researches")}async getResearchById(e){return this.request(`/Researches/${e}`)}async createResearch(e){return this.request("/Researches",{method:"POST",body:JSON.stringify(e)})}async updateResearch(e,r){return this.request(`/Researches/${e}`,{method:"PUT",body:JSON.stringify(r)})}async deleteResearch(e){await this.request(`/Researches/${e}`,{method:"DELETE"})}async getAllGroups(){return this.request("/groups")}async getGroupById(e){return this.request(`/groups/${e}`)}async createGroup(e){return this.request("/groups",{method:"POST",body:JSON.stringify(e)})}async updateGroup(e,r){return this.request(`/groups/${e}`,{method:"PUT",body:JSON.stringify(r)})}async deleteGroup(e){await this.request(`/groups/${e}`,{method:"DELETE"})}async getAllProducts(){return this.request("/products")}async getProductById(e){return this.request(`/products/${e}`)}async createProduct(e){return this.request("/products",{method:"POST",body:JSON.stringify(e)})}async updateProduct(e,r){return this.request(`/products/${e}`,{method:"PUT",body:JSON.stringify(r)})}async deleteProduct(e){await this.request(`/products/${e}`,{method:"DELETE"})}}const se=new _o;var go=Object.defineProperty,bo=Object.getOwnPropertyDescriptor,ot=(t,e,r,n)=>{for(var i=n>1?void 0:n?bo(e,r):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(n?s(e,r,i):s(i))||i);return n&&i&&go(e,r,i),i};let G=class extends S{constructor(){super(),this.username="",this.password="",this.error=null}onInput(t){const e=t.target;this[e.name]=e.value}async onSubmit(t){if(t.preventDefault(),this.error=null,!this.username.trim()||!this.password.trim()){this.error="Username and password are required";return}try{await se.login({username:this.username,password:this.password}),this.navigateTo("/dashboard")}catch(e){this.error="Invalid username or password",console.error("Login error:",e)}}navigateTo(t){console.debug("[login-view] navigateTo ->",t,"current=",window.location.pathname),O.go(t)}render(){return _`
  ...
  `;ot([y()],G.prototype,"username",2);ot([y()],G.prototype,"password",2);ot([y()],G.prototype,"error",2);G=ot([de("login-view")],G);const yo=Object.freeze(Object.defineProperty({__proto__:null,get LoginView(){return G}},Symbol.toStringTag,{value:"Module"}));var vo=Object.defineProperty,wo=Object.getOwnPropertyDescriptor,J=(t,e,r,n)=>{for(var i=n>1?void 0:n?wo(e,r):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=(n?s(e,r,i):s(i))||i);return n&&i&&vo(e,r,i),i};let k=class extends S{constructor(){super(),this.name="",this.email="",this.password="",this.phone="",this.error=null,this.success=null}onInput(t){const e=t.target;this[e.name]=e.value}async onSubmit(t){if(t.preventDefault(),this.error=null,this.success=null,!this.name.trim()||!this.email.trim()||!this.password.trim()){this.error="Name, username and password are required";return}try{await se.createUser({name:this.name,email:this.email,password:this.password,phone:this.phone}),this.success="Account created successfully. Redirecting to log in...",setTimeout(()=>{this.navigateTo("/login")},700)}catch(e){this.error=e instanceof Error?e.message:"Failed to register",console.error(e)}}navigateTo(t){console.debug("[register-view] navigateTo ->",t,"current=",window.location.pathname);const e=document.getElementById("outlet");if(e&&t==="/login"){e.innerHTML="";const r=document.createElement("login-view");e.appendChild(r),history.pushState({},"",t),console.debug("[register-view] manually rendered login");return}try{history.pushState({},"",t),window.dispatchEvent(new PopStateEvent("popstate"))}catch(r){console.warn("[register-view] navigateTo fallback failed",r),window.location.href=t}}render(){return _`
      <div class="container">
        <div class="card">
  ...
  `;J([y()],k.prototype,"name",2);J([y()],k.prototype,"email",2);J([y()],k.prototype,"password",2);J([y()],k.prototype,"phone",2);J([y()],k.prototype,"error",2);J([y()],k.prototype,"success",2);k=J([de("register-view")],k);const Eo=Object.freeze(Object.defineProperty({__proto__:null,get RegisterView(){return k}},Symbol.toStringTag,{value:"Module"}));/**
 * @license
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Wo=/(url\()([^)]*)(\))/g,Yo=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/,De,x;function Pe(t,e){if(t&&Yo.test(t)||t==="//")return t;if(De===void 0){De=!1;try{const r=new URL("b","http://a");r.pathname="c%20d",De=r.href==="http://a/c%20d"}catch{}}if(e||(e=document.baseURI||window.location.href),De)try{return new URL(t,e).href}catch{return t}return x||(x=document.implementation.createHTMLDocument("temp"),x.base=x.createElement("base"),x.head.appendChild(x.base),x.anchor=x.createElement("a"),x.body.appendChild(x.anchor)),x.base.href=e,x.anchor.href=t,x.anchor.href||t}function Bt(t,e){return t.replace(Wo,function(r,n,i,o){return n+"'"+Pe(i.replace(/["']/g,""),e)+"'"+o})}function Vt(t){return t.substring(0,t.lastIndexOf("/")+1)}/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let ns=0;const ue=function(t){let e=t.__mixinApplications;e||(e=new WeakMap,t.__mixinApplications=e);let r=ns++;function n(i){let o=i.__mixinSet;if(o&&o[r])return i;let s=e,a=s.get(i);if(!a){a=t(i),s.set(i,a);let l=Object.create(a.__mixinSet||o||null);l[r]=!0,a.__mixinSet=l}return a}return n};/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
 ...
 * Copyright (c) 2021 - 2025 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function Dl(t){const e=[];for(;t;){if(t.nodeType===Node.DOCUMENT_NODE){e.push(t);break}if(t.nodeType===Node.DOCUMENT_FRAGMENT_NODE){e.push(t),t=t.host;continue}if(t.assignedSlot){t=t.assignedSlot;continue}t=t.parentNode}return e}function Ua(t,e){return e?e.closest(t)||Ua(t,e.getRootNode().host):null}function Zi(t){return t?new Set(t.split(" ")):new Set}function en(t){return t?[...t].join(" "):""}function zl(t,e,r){const n=Zi(t.getAttribute(e));n.add(r),t.setAttribute(e,en(n))}function Ul(t,e,r){const n=Zi(t.getAttribute(e));if(n.delete(r),n.size===0){t.removeAttribute(e);return}t.setAttribute(e,en(n))}function Fa(t){return t.nodeType===Node.TEXT_NODE&&t.textContent.trim()===""}/**
 * @license
 ...
 * Copyright (c) 2021 - 2025 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */let Xt=!1;window.addEventListener("keydown",()=>{Xt=!0},{capture:!0});window.addEventListener("mousedown",()=>{Xt=!1},{capture:!0});function Bl(){let t=document.activeElement||document.body;for(;t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}function hl(){return Xt}function sn(t){const e=t.style;if(e.visibility==="hidden"||e.display==="none")return!0;const r=window.getComputedStyle(t);return r.visibility==="hidden"||r.display==="none"}function pl(t,e){const r=Math.max(t.tabIndex,0),n=Math.max(e.tabIndex,0);return r===0||n===0?n>r:r>n}function fl(t,e){const r=[];for(;t.length>0&&e.length>0;)pl(t[0],e[0])?r.push(e.shift()):r.push(t.shift());return r.concat(t,e)}function Lt(t){const e=t.length;if(e<2)return t;const r=Math.ceil(e/2),n=Lt(t.slice(0,r)),i=Lt(t.slice(r));return fl(n,i)}function Vl(t){return t.checkVisibility?!t.checkVisibility({visibilityProperty:!0}):t.offsetParent===null&&t.clientWidth===0&&t.clientHeight===0?!0:sn(t)}function ml(t){return t.matches('[tabindex="-1"]')?!1:t.matches("input, select, textarea, button, object")?t.matches(":not([disabled])"):t.matches("a[href], area[href], iframe, [tabindex], [contentEditable]")}function ql(t){return t.getRootNode().activeElement===t}function _l(t){if(!ml(t))return-1;const e=t.getAttribute("tabindex")||0;return Number(e)}function an(t,e){if(t.nodeType!==Node.ELEMENT_NODE||sn(t))return!1;const r=t,n=_l(r);let i=n>0;n>=0&&e.push(r);let o=[];return r.localName==="slot"?o=r.assignedNodes({flatten:!0}):o=(r.shadowRoot||r).children,[...o].forEach(s=>{i=an(s,e)||i}),i}function Wl(t){const e=[];return an(t,e)?Lt(e):e}/**
 * @license
 * Copyright (c) 2021 - 2025 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 ...
 */st("vaadin-button",Wa,{moduleId:"vaadin-button-styles"});class wl extends vl(za(Io(wa(ya)))){static get properties(){return{disabled:{type:Boolean,value:!1}}}static get is(){return"vaadin-button"}static get template(){return ba`
    ...
    `}ready(){super.ready(),this._tooltipController=new qa(this),this.addController(this._tooltipController)}__shouldAllowFocusWhenDisabled(){return window.Vaadin.featureFlags.accessibleDisabledButtons}}Pi(wl);var El=Object.getOwnPropertyDescriptor,Pl=(t,e,r,n)=>{for(var i=n>1?void 0:n?El(e,r):e,o=t.length-1,s;o>=0;o--)(s=t[o])&&(i=s(i)||i);return i};let it=class extends S{connectedCallback(){super.connectedCallback(),console.log("[landing-view] connectedCallback called")}render(){return console.log("[landing-view] render called"),_`
  ...
  `;it=Pl([de("landing-view")],it);const ei=Object.freeze(Object.defineProperty({__proto__:null,get LandingView(){return it}},Symbol.toStringTag,{value:"Module"}));var ct=function(t,e,r,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,r,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(o=(i<3?s(o):i>3?s(e,r,o):s(e,r))||o);return i>3&&o&&Object.defineProperty(e,r,o),o},Qt=function(t,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(t,e)};let ae=class extends S{constructor(){super(...arguments),Object.defineProperty(this,"users",{enumerable:!0,configurable:!0,writable:!0,value:[]}),Object.defineProperty(this,"loading",{enumerable:!0,configurable:!0,writable:!0,value:!0}),Object.defineProperty(this,"error",{enumerable:!0,configurable:!0,writable:!0,value:null})}async connectedCallback(){super.connectedCallback(),await this.loadUsers()}async loadUsers(){try{this.loading=!0,this.error=null,this.users=await se.getAllUsers()}catch(e){this.error=e instanceof Error?e.message:"Failed to load users",console.error("Error loading users:",e)}finally{this.loading=!1}}async deleteUser(e){if(confirm("Are you sure you want to delete this user?"))try{await se.deleteUser(e),await this.loadUsers()}catch(r){this.error=r instanceof Error?r.message:"Failed to delete user",console.error("Error deleting user:",r)}}render(){return _`
      <div class="user-list">
        <h2>Users</h2>
  ...
  `});ct([y(),Qt("design:type",Array)],ae.prototype,"users",void 0);ct([y(),Qt("design:type",Object)],ae.prototype,"loading",void 0);ct([y(),Qt("design:type",Object)],ae.prototype,"error",void 0);ae=ct([de("user-list")],ae);var he=function(t,e,r,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,r,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(o=(i<3?s(o):i>3?s(e,r,o):s(e,r))||o);return i>3&&o&&Object.defineProperty(e,r,o),o},Me=function(t,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(t,e)};let F=class extends S{constructor(){super(...arguments),Object.defineProperty(this,"user",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"formData",{enumerable:!0,configurable:!0,writable:!0,value:{firstName:"",lastName:"",email:"",password:"",phone:""}}),Object.defineProperty(this,"loading",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"error",{enumerable:!0,configurable:!0,writable:!0,value:null}),Object.defineProperty(this,"success",{enumerable:!0,configurable:!0,writable:!0,value:null})}updated(e){e.has("user")&&this.user&&(this.formData={name:`${this.user.firstName||""} ${this.user.lastName||""}`.trim(),email:this.user.email||"",password:"",phone:this.user.phone||""})}handleInputChange(e){const r=e.target,{name:n,value:i}=r;this.formData={...this.formData,[n]:i}}async handleSubmit(e){var r,n;if(e.preventDefault(),!this.formData.name.trim()||!this.formData.email.trim()){this.error="Name and email are required";return}if(!((r=this.user)!=null&&r.id)&&!this.formData.password.trim()){this.error="Password is required for new users";return}try{this.loading=!0,this.error=null,this.success=null,(n=this.user)!=null&&n.id?(await se.updateUser(this.user.id,this.formData),this.success="User updated successfully!"):(await se.createUser(this.formData),this.success="User created successfully!",this.formData={name:"",email:"",password:"",phone:""}),this.dispatchEvent(new CustomEvent("user-saved"))}catch(i){this.error=i instanceof Error?i.message:"Failed to save user",console.error("Error saving user:",i)}finally{this.loading=!1}}handleCancel(){this.dispatchEvent(new CustomEvent("cancel"))}render(){return _`
      <div class="user-form">
  ...
  `});he([Ei({type:Object}),Me("design:type",Object)],F.prototype,"user",void 0);he([y(),Me("design:type",Object)],F.prototype,"formData",void 0);he([y(),Me("design:type",Object)],F.prototype,"loading",void 0);he([y(),Me("design:type",Object)],F.prototype,"error",void 0);he([y(),Me("design:type",Object)],F.prototype,"success",void 0);F=he([de("user-form")],F);var Zt=function(t,e,r,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,r,n);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(o=(i<3?s(o):i>3?s(e,r,o):s(e,r))||o);return i>3&&o&&Object.defineProperty(e,r,o),o},ln=function(t,e){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(t,e)};let le=class extends S{constructor(){super(...arguments),Object.defineProperty(this,"showForm",{enumerable:!0,configurable:!0,writable:!0,value:!1}),Object.defineProperty(this,"editingUser",{enumerable:!0,configurable:!0,writable:!0,value:null})}handleCreateUser(){this.editingUser=null,this.showForm=!0}handleEditUser(e){this.editingUser=e.detail,this.showForm=!0}handleCancelForm(){this.showForm=!1,this.editingUser=null}handleUserSaved(){this.showForm=!1,this.editingUser=null}render(){return _`
  ...
  `});Zt([y(),ln("design:type",Object)],le.prototype,"showForm",void 0);Zt([y(),ln("design:type",Object)],le.prototype,"editingUser",void 0);le=Zt([de("user-management")],le);const xl=Object.freeze(Object.defineProperty({__proto__:null,get UserManagement(){return le}},Symbol.toStringTag,{value:"Module"}));async function ti(){try{const t=document.getElementById("outlet");if(!t)throw new Error("Could not find the outlet element");const e=new O(t);console.debug("[main] router created",e),window.vaadin=window.vaadin||{},window.vaadin.router=e,window.router=e,console.log("[main] router set globally:",!!e);try{window.dispatchEvent(new CustomEvent("vaadin-router-ready",{detail:{router:e}}))}catch{}e.setRoutes([{path:"/",component:"landing-view",action:()=>{Q(()=>Promise.resolve().then(()=>ei),void 0)}},{path:"/login",component:"login-view",action:(o,s)=>localStorage.getItem("isAuthenticated")==="true"?s.redirect("/users"):Q(()=>Promise.resolve().then(()=>yo),void 0)},{path:"/register",component:"register-view",action:(o,s)=>localStorage.getItem("isAuthenticated")==="true"?s.redirect("/users"):Q(()=>Promise.resolve().then(()=>Eo),void 0)},{path:"/users",component:"user-management",action:(o,s)=>localStorage.getItem("isAuthenticated")!=="true"?s.redirect("/login"):Q(()=>Promise.resolve().then(()=>xl),void 0)},{path:"/dashboard",component:"new-dashboard-view",action:(o,s)=>localStorage.getItem("isAuthenticated")!=="true"?s.redirect("/login"):Q(()=>import("./new-dashboard-view-Cm0lxhoY.js"),[])},{path:"(.*)",component:"landing-view",action:()=>{Q(()=>Promise.resolve().then(()=>ei),void 0)}}]);const r=localStorage.getItem("isAuthenticated")==="true",n=window.location.pathname;!r&&!["/login","/register","/"].includes(n)?O.go("/login"):r&&["/login","/register"].includes(n)&&O.go("/dashboard");const i=document.querySelector("#outlet > div");i&&i.remove()}catch(t){console.error("Failed to initialize the app:",t);const e=document.createElement("div");e.style.color="red",e.style.padding="20px",e.style.textAlign="center",e.innerHTML=`
    ...
    `;const r=document.getElementById("app")||document.body;r.innerHTML="",r.appendChild(e)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ti):ti();export{O as $,ba as A,b as B,wa as C,tt as D,za as E,gl as F,ne as G,Cl as H,po as I,Va as J,dl as K,To as L,ul as M,Dl as N,vl as O,ya as P,Ba as Q,$a as R,ja as S,bl as T,Ft as U,_i as V,_ as W,S as X,y as Y,de as Z,se as _,Re as a,zl as b,Ul as c,Rl as d,Da as e,Pi as f,Ra as g,Ml as h,A as i,Na as j,ml as k,Vl as l,ka as m,Xr as n,hl as o,lt as p,Zi as q,st as r,en as s,kl as t,Wl as u,ql as v,Bl as w,Ua as x,qa as y,Io as z};
//# sourceMappingURL=main-CgzL_46l.js.map
